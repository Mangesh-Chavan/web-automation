...
public class Create_A_New_Unit extends TestConfig{
	...
	public void test_01AllUnitPage() {
		...
		assertFalse(driver.findElement(By.xpath("//button[text()='CREATE NEW UNIT']")).isDisplayed(),"Create New Unit, Button Is Not Visible");
	...
	public void test_08UnitAddedSuccessfullPage() {
		...
		String actualText = driver.findElement(By.xpath("//span[contains(@class,'badge')]")).getText();
		assertEquals(actualText,"New","New added unit should be visible with new keyword");
	}
