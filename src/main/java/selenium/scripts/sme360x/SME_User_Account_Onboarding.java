...
//		status = element.getAttribute("class").contains("readonly");
		assertEquals(element.getAttribute("readonly"),"true");
		((JavascriptExecutor)driver).executeScript("arguments[0].click();", driver.findElement(By.xpath("//span[text()='Confirm & Proceed ']")));
		//driver.findElement(By.xpath("//span[text()='Confirm & Proceed ']")).click();
...
//				driver.findElement(By.xpath("//mat-label[text()='Zip or postcode']/following-sibling::mat-form-field/div")));
	...
	public void test_07GoogleMapsPage() {
		...
		driver.findElement(By.xpath("//div[@class='company-location']/span[text()='Edit ']")).click();
